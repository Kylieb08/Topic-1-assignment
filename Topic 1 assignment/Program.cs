namespace Topic_1_assignment
{
    internal class Program
    {
        static void Main(string[] args)
            //Kylie Banman
        {
            Console.WriteLine("Hello, my  name is Kylie");
            Console.WriteLine("");
            /*The following three lines are a multi-line explination of 
             how comments work and why they might be used. This comment is across multiple lines
             for visibility*/
